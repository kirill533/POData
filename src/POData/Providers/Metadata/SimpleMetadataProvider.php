...
class SimpleMetadataProvider implements IMetadataProvider
{
     ...
     * @param TypeCode|int $typeCode     type of the key property
     */
     ...
     *                                   is to be added
     * @param string       $name         name of the key property
     * @param int|TypeCode $typeCode     type of the key property
     * @param bool         $isBag        property is bag or not
     * @param null|mixed   $defaultValue
     * @param mixed        $nullable
     */
     ...
     *                                   is to be added
     * @param string       $name         name of the property
     * @param TypeCode|int $typeCode     type of the etag property
     * @param null|mixed   $defaultValue
     * @param mixed        $nullable
     */
